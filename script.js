...
const translations = {
  ...
  zh: {
    heroTitle: "大家好，我是 Sarthak，一名热衷于构建有影响力的软件的软件工程专业学生。",
    heroDesc: "我构建可扩展的应用程序并喜欢通过代码解决实际问题。",
    aboutTitle: "关于我",
    aboutText:
      "我叫 Sarthak Acharya，是东卡罗来纳大学软件工程专业的学生。我出生并成长于尼泊尔加德满都，很小的时候就对科技产生了好奇。大约三岁时，我接触了电脑，最初的学习和游戏逐渐发展成对通过代码构建和解决问题的浓厚兴趣。<br><br>如今，我热衷于创建可扩展、用户友好且创新的解决方案，同时不断提升自己作为学生和工程师的技能。我的软件工程之旅源于好奇心以及将想法变成现实的兴奋。<br><br>学术之余，我热爱运动、旅行和骑摩托车。这些爱好让我保持活力、勇于冒险，并乐于接受新体验，这也塑造了我应对生活和科技挑战的方式。",
    workTitle: "工作经验",
    workContent:
